...
class _DetailsPageState extends State<DetailsPage> {
                    ...
                    Container(
                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          buildIngredientItem(
                            'Sugar',
                            const Icon(Feather.box, size: 18.0, color: Colors.white),
                          ...
                          buildIngredientItem(
                            'Vanilla Syrup',
                            const Icon(MaterialCommunityIcons.flower_tulip_outline,
                                size: 18.0, color: Colors.white),
  ...
  Widget buildImage(double left, String imagePath) {
    return Positioned(
      left: left,
      child: Container(
        height: 35.0,
  ...
  Widget buildIngredientItem(String name, Icon iconName, Color bgColor) {
    return Padding(
